...
$LANG['edeploysnowclient'] = [
    ...
    'Default Technician for Auto-Assignment' => 'Técnico Padrão para Atribuição Automática',
    'Default Group for Auto-Assignment' => 'Grupo Padrão para Atribuição Automática',
    'Default Solution Type' => 'Tipo de Solução Padrão',
    'Default Solution Template' => 'Modelo de Solução Padrão',
    'Default Ticket Category' => 'Categoria de Chamado Padrão',
    ...
    'User for API operations and follow-ups' => 'Usuário para operações da API e acompanhamentos',
    'Technician to be assigned automatically when solving tickets without assignment' => 'Técnico a ser atribuído automaticamente ao resolver tickets sem atribuição',
    'Group to be assigned automatically when solving tickets without group assignment' => 'Grupo a ser atribuído automaticamente ao resolver tickets sem atribuição de grupo',
    'Solution type to be used when solving tickets' => 'Tipo de solução a ser usado ao resolver tickets',
    'Solution template to be used when solving tickets' => 'Modelo de solução a ser usado ao resolver tickets',
    'Category to be assigned automatically when solving tickets without category' => 'Categoria a ser atribuída automaticamente ao resolver tickets sem categoria',
    'Select a user...' => 'Selecione um usuário...',
    'Select a technician...' => 'Selecione um técnico...',
    'Select a group...' => 'Selecione um grupo...',
    'Select a solution type...' => 'Selecione um tipo de solução...',
    'Select a solution template...' => 'Selecione um modelo de solução...',
