...
$LANG['edeploysnowclient'] = [
    ...
    'Default Group for Auto-Assignment' => 'Default Group for Auto-Assignment',
    'Default Solution Type' => 'Default Solution Type',
    'Default Solution Template' => 'Default Solution Template',
    ...
    'Group to be assigned automatically when solving tickets without group assignment' => 'Group to be assigned automatically when solving tickets without group assignment',
    'Solution type to be used when solving tickets' => 'Solution type to be used when solving tickets',
    'Solution template to be used when solving tickets' => 'Solution template to be used when solving tickets',
    'Category to be assigned automatically when solving tickets without category' => 'Category to be assigned automatically when solving tickets without category',
    'Select a user...' => 'Select a user...',
    'Select a technician...' => 'Select a technician...',
    'Select a group...' => 'Select a group...',
    'Select a solution type...' => 'Select a solution type...',
    'Select a solution template...' => 'Select a solution template...',
